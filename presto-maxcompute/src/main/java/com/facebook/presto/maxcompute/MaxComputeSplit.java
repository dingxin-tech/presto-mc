        ...
        implements ConnectorSplit
{
    ...
    public MaxComputeSplit(
            @JsonProperty("identifier") TableIdentifier identifier,
    ...
    public MaxComputeSplit(TableIdentifier identifier, MaxComputeInputSplit split, TableBatchReadSession session, Map<String, String> properties)
    {
        this.identifier = requireNonNull(identifier, "identifier is null");
        this.split = requireNonNull(split, "split is null");
