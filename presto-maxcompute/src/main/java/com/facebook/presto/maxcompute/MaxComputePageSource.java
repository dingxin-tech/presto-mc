        ...
        implements ConnectorPageSource
{
            ...
            MaxComputeSplit split)
    {
        ...
        TableIdentifier identifier = split.getIdentifier();

        TableSchema schema = odps.tables().get(identifier.getProject(), identifier.getSchema(), identifier.getTable()).getSchema();
